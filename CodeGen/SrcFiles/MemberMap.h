// Member Map logic, Version 1.5.3.0
...
public:
  ...
  MemberRecord* startLoop()  {it = myMap.begin();  return curRcd();}
  MemberRecord* nextRecord() {return it == myMap.end() ? 0 : increment ? bmp() : curRcd();}
  MemberRecord* curRcd()     {increment = true; return it != myMap.end() ? &it->second : 0;}
...
private:
  ...
  MemberRecord* bmp() {return ++it != myMap.end() ? &it->second : 0;}
  };
