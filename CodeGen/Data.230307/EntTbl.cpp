...
EntRcd* EntTbl::find(TCchar* firstName, TCchar* middleInitial, TCchar* lastName, TCchar* eMail, TCchar* phone1) {
EntIter iter(*this);
EntRcd* rcd;

  for (rcd = iter(); rcd; rcd = iter++) if (rcd->contains(firstName, middleInitial, lastName, eMail, phone1)) return rcd;
