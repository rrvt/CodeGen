...
String phone2;
 ...
 ~EntRcd() { }
  ...
  bool contains(TCchar* firstName, TCchar* middleInitial, TCchar* lastName, TCchar* eMail, TCchar* phone1) {
    return this->firstName == firstName && this->middleInitial == middleInitial && this->lastName == lastName &&
         this->eMail == eMail && this->phone1 == phone1;
    }
...
String name;
 ...
 ~EntTbl() {clear();}
  ...
  EntRcd* find(TCchar* firstName, TCchar* middleInitial, TCchar* lastName, TCchar* eMail, TCchar* phone1);
