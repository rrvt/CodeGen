...
String description;
 ...
 ~StsRcd() { }
  ...
  bool contains(TCchar* abbreviation, TCchar* description) {
    return this->abbreviation == abbreviation && this->description == description;
    }
...
String name;
 ...
 ~StsTbl() {clear();}
  ...
  StsRcd* find(TCchar* abbreviation, TCchar* description);
